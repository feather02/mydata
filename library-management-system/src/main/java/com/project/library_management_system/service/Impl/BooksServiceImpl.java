...
public class BooksServiceImpl implements BooksService {
    ...
    public boolean isAvailable(Books books) {
        return (boolean) booksRepository.findById(books.getId())
                .map(Books::getAvailable)
                .orElse(false);
    }

    @Override
    public void checkAvailability(Books books, boolean b) {
    ...
    @Override
    public void updateBookAvailability(int id, boolean status) {
